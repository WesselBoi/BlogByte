...
//         <h1 className="text-4xl font-extrabold text-center mb-8 text-indigo-700">My Blog Collection</h1>
...
//                       <Pencil className='cursor-pointer text-indigo-400 hover:text-indigo-600 transition-all'/>
//                       <BadgeMinus className='cursor-pointer text-red-400 hover:text-red-600 transition-all' onClick={()=> deleteBlog(blog._id)}/>
//                     </div>
//                   </div>
