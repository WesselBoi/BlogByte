    ...
    <div className="min-h-screen flex items-center justify-center bg-indigo-50 px-4">
      <div className="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 border border-indigo-100">
        <div className="mb-8 text-center">
          ...
          <p className="text-indigo-600 mt-1">Login to your Blog account</p>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="mt-6">
          <Link to="/signup" className="w-full flex justify-center py-3 px-4 border border-indigo-300 rounded-lg shadow-sm text-base font-medium text-indigo-700 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
            Sign Up
          </Link>
          </div>
        </div>
